                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a class="text-gray-900 dark:text-white">人気の投稿</a></div>
                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <ul>
                                                            @foreach ($favorite_books as $favorite_book)
                                                                <a href="{{ url('/manual/'.$favorite_book->id.'') }}">★{{ $favorite_book->title }}</a><br>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                </div>
...
　　　　　　　　　　　　
                        ...
                        <div class="max-w-2xl mx-auto">
                        	...
                        	<form method="GET" action="{{ url('/') }}" class="flex items-center">   
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="search" placeholder="キーワードを入力" name="search" value="@if (isset($search)) {{ $search }} @endif" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="キーワードを入力">
                                </div>
                                <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"><a href="{{ url('/') }}"></a></path></svg></button>
                            </form>
        ...
        @if($book->flag_open =='1')
        <div class="p-10 md:w-1/3" style="margin: 50px 20px">
        <br>
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden" "><a href="{{ url('manual/'.$book->id.'') }}">
